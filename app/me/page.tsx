...
export default function UserDashboard() {
  ...
  const calculateStats = (userData: any) => {
    ...
    const fields = ["name", "email", "phone", "photo", "slug"]
    const infoFields = userData.info?.[0] ? ["bio", "tagline"] : []
    ...
    setStats({
      ...
      settingsUpdated: userData.updatedAt
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
        <div className="flex items-center space-x-6">
          ...
          <div className="flex-1">
            ...
            {user?.info?.[0]?.tagline && <p className="text-sm text-gray-500 mt-1">{user.info[0].tagline}</p>}
            <div className="mt-3">
