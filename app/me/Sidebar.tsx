...
export default function UserSidebar({ isMobileOpen, onClose }: { isMobileOpen?: boolean; onClose?: () => void }) {
  ...
  return (
    <>
      ...
      <div
        ...
        } h-full flex-col justify-between sticky top-0`}
      >
        ...
        <div className="p-4 border-b border-gray-200">
          <div className="flex items-center justify-between">
            ...
            <button onClick={() => setIsCollapsed(!isCollapsed)} className="p-1 rounded-lg hover:bg-gray-100 transition-colors">
          ...
          {!isCollapsed && (
            <div className="flex items-center space-x-3">
              <div className="h-10 w-10 rounded-full bg-gray-300 flex items-center justify-center">
                {user?.photo ? (
                  <img className="h-10 w-10 rounded-full object-cover" src={user.photo || "/placeholder.svg"} alt={user.name} />
                ) : (
